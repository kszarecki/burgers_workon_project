...
class acau_settings {
	...
	public function __construct() {
		...
		$this->settings_list = [
			...
			'acau_custom_spinning_wheel'=> [ 'val' => false, 	'title' => __( 'Custom spinning wheels', 'ajax-cart-autoupdate-for-woocommerce' ), 	'type' => 'checkbox',	'tab' => 'configuration',
											 'descr' => __( 'Change how the spinning wheels look like.', 'ajax-cart-autoupdate-for-woocommerce' ) ],
	...
	public function load_textdomain() {
		load_plugin_textdomain( 'ajax-cart-autoupdate-for-woocommerce', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
	}
